...
# Every case owns a temporary directory that is removed when the case ends,
# so a run leaves nothing behind in TEMP. A failed removal fails the run.
