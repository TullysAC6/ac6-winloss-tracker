...
ENTRIES = (
    ...
    Entry("tests/test_broadcast_overlay.py", T0,
          "UI-1B Broadcast overlay source contracts, its script under node, and the /config preference",
          selectors=("BroadcastStaticTests", "BroadcastDomTests", "BroadcastConfigTests")),
