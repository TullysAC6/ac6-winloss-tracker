...
| **DESIGN SPEC COMPLETE — HUMAN REVIEW PENDING** | UI-0 documentation is drafted and implementation-ready, but is not accepted and authorizes no UI code until human review completes |
...
## Position note — 2026-09-22

- [UI-0](UI0_DESIGN_SPEC.md) is **DESIGN SPEC COMPLETE — HUMAN REVIEW PENDING** on a documentation-only branch from `fbc2131d177aa3fb5b271c1bd6894440e07c97e0`.
...
- No production code, test, runtime, dependency, or framework changed. UI-1A and every later implementation phase remain not started.
...
2. UI-0 design specification ([#25](https://github.com/TullysAC6/ac6-winloss-tracker/issues/25)) - **DESIGN SPEC COMPLETE — HUMAN REVIEW PENDING**; documentation only, human review before any UI code
...
|---|---|---|---|
| UI-0 | [Design specification](UI0_DESIGN_SPEC.md) — current framework survey, Player Overlay, Broadcast Overlay, Dashboard, History, Settings, Launcher, performance, lifecycle, DPI, accessibility; Before → Proposed per item; Low/Medium/High classification; rollback plan; regression-test plan. **No code change. Human review before any implementation** | **DESIGN SPEC COMPLETE — HUMAN REVIEW PENDING** | none |
