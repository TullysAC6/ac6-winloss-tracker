...
- Canonical requirements are at **Revision 3** (2026-09-12), adding §56 runtime isolation and §57–§63 UI/UX, and promoting §52 self-build linkage to a recorded requirement.
...
Three things in there are easy to erode and are the reason they are written down:
